...
- Name: visual_baseline.spec.ts >> mobile (375px) >> letters-mark-spam - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 996px, received 383px by 968px. 185060 pixels (ratio 0.49 of all image pixels) are different.

  Snapshot: letters-mark-spam-mobile.png

Call log:
  - Expect "toHaveScreenshot(letters-mark-spam-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e74]:
          ...
          - link "Wniosek o udostępnienie informacji publicznej" [ref=e75] [cursor=pointer]:
            - /url: /listy/7302
        - listitem [ref=e76]: / Oznacz jako (nie-)spam
      - generic [ref=e80]:
      ...
      - generic [ref=e88]:
        ...
        - generic [ref=e98]:
          ...
          - generic [ref=e99]:
            - button "Oznacz jako spam" [ref=e100] [cursor=pointer]
            - button "Oznacz jako nie-spam" [ref=e101] [cursor=pointer]
      - generic [ref=e102]:
        - generic [ref=e103]:
  ...
  - list [ref=e115]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Historia /listy/7302/~oznacz-spam" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
    ...
    - listitem [ref=e128]:
      ...
      - 'link "Czas CPU: 86.71ms (89.69ms)" [ref=e130] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e131]:
    ...
    - listitem [ref=e137]:
      ...
      - link "Zapytania LetterMarkSpamView" [ref=e139] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e140]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e141]
      - link "SQL 11 queries in 3.48ms" [ref=e142] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e143]:
    ...
    - listitem [ref=e146]:
      ...
      - link "Templatki letters/letter_mark_spam.html" [ref=e148] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e149]:
    ...
    - listitem [ref=e152]:
      ...
      - link "Cache 2 wywołania w 0.14ms" [ref=e154] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e155]:
