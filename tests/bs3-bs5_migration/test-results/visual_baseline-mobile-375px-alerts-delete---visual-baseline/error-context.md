...
- Name: visual_baseline.spec.ts >> mobile (375px) >> alerts-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 396px by 812px, received 383px by 812px. 170155 pixels (ratio 0.53 of all image pixels) are different.

  Snapshot: alerts-delete-mobile.png

Call log:
  - Expect "toHaveScreenshot(alerts-delete-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e84]:
        - text: Czy na pewno chcesz usunąć "2017-10-18 20:41:18.641909+00:00"?
  ...
  - list [ref=e100]:
    ...
    - listitem [ref=e107]:
      ...
      - link "Historia /alerty/1/~usun" [ref=e109] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e110]:
    ...
    - listitem [ref=e113]:
      ...
      - 'link "Czas CPU: 80.84ms (83.19ms)" [ref=e115] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e116]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Zapytania AlertDeleteView" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e126]
      - link "SQL 9 queries in 2.66ms" [ref=e127] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e128]:
    ...
    - listitem [ref=e131]:
      ...
      - link "Templatki alerts/alert_confirm_delete.html" [ref=e133] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e134]:
