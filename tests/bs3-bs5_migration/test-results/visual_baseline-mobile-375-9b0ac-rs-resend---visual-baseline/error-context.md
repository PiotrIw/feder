...
- Name: visual_baseline.spec.ts >> mobile (375px) >> letters-resend - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 962px, received 383px by 933px. 185341 pixels (ratio 0.50 of all image pixels) are different.

  Snapshot: letters-resend-mobile.png

Call log:
  - Expect "toHaveScreenshot(letters-resend-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e74]:
          ...
          - link "Wniosek o udostępnienie informacji publicznej" [ref=e75] [cursor=pointer]:
            - /url: /listy/7302
        - listitem [ref=e76]: / Wyślij ponownie list
      - generic [ref=e80]:
      ...
      - generic [ref=e88]:
        ...
        - generic [ref=e98]:
          - text: Czy jesteś pewien, że chcesz wysłać ponownie "Wniosek o udostępnienie informacji publicznej"?
          - button "Resend letter" [ref=e100] [cursor=pointer]
      - generic [ref=e101]:
        - generic [ref=e102]:
  ...
  - list [ref=e114]:
    ...
    - listitem [ref=e121]:
      ...
      - link "Historia /listy/7302/~resend" [ref=e123] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e124]:
    ...
    - listitem [ref=e127]:
      ...
      - 'link "Czas CPU: 94.26ms (96.91ms)" [ref=e129] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e130]:
    ...
    - listitem [ref=e136]:
      ...
      - link "Zapytania LetterResendView" [ref=e138] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e139]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e140]
      - link "SQL 8 queries in 3.15ms" [ref=e141] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e142]:
    ...
    - listitem [ref=e145]:
      ...
      - link "Templatki letters/letter_resend.html" [ref=e147] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e148]:
    ...
    - listitem [ref=e151]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e153] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e154]:
