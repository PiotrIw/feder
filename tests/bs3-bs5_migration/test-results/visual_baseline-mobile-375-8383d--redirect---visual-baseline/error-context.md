...
- Name: visual_baseline.spec.ts >> mobile (375px) >> users-redirect - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  171697 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: users-redirect-mobile.png

Call log:
  - Expect "toHaveScreenshot(users-redirect-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e93]:
    ...
    - listitem [ref=e106]:
      ...
      - 'link "Czas CPU: 62.20ms (64.58ms)" [ref=e108] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e118]:
      ...
      - link "SQL 7 queries in 2.21ms" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
