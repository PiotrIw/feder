...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> users-detail - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  337434 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: users-detail-desktop.png

Call log:
  - Expect "toHaveScreenshot(users-detail-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e85]:
    ...
    - listitem [ref=e98]:
      ...
      - 'link "Czas CPU: 83.94ms (78.31ms)" [ref=e100] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e101]:
    ...
    - listitem [ref=e110]:
      ...
      - link "SQL 8 queries in 2.98ms" [ref=e112] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e113]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Cache 2 wywołania w 0.17ms" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
