...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-reset-password-done - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  167506 pixels (ratio 0.56 of all image pixels) are different.

  Snapshot: account-reset-password-done-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-reset-password-done-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e71]:
        ...
        - paragraph [ref=e75]: Wysłaliśmy Tobie e-mail. Proszę skontaktuj się z nami, jeśli go nie otrzymasz w ciągu paru minut.
      - generic [ref=e76]:
        - generic [ref=e77]:
  ...
  - list [ref=e89]:
    ...
    - listitem [ref=e96]:
      ...
      - link "Historia /accounts/password/reset/done/" [ref=e98] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e99]:
    ...
    - listitem [ref=e102]:
      ...
      - 'link "Czas CPU: 57.36ms (58.89ms)" [ref=e104] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e105]:
    ...
    - listitem [ref=e111]:
      ...
      - link "Zapytania PasswordResetDoneView" [ref=e113] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e114]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e115]
      - link "SQL 4 queries in 1.20ms" [ref=e116] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e117]:
    ...
    - listitem [ref=e120]:
      ...
      - link "Templatki account/password_reset_done.html" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
    ...
    - listitem [ref=e126]:
      ...
      - link "Cache 2 wywołania w 0.11ms" [ref=e128] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e129]:
