...
- Name: visual_baseline.spec.ts >> mobile (375px) >> letters-spam - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 555px by 1390px, received 555px by 1425px. 185507 pixels (ratio 0.24 of all image pixels) are different.

  Snapshot: letters-spam-mobile.png

Call log:
  - Expect "toHaveScreenshot(letters-spam-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e107]:
    ...
    - listitem [ref=e120]:
      ...
      - 'link "Czas CPU: 49.51ms (51.04ms)" [ref=e122] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e123]:
    ...
    - listitem [ref=e132]:
      ...
      - link "SQL 5 queries in 1.41ms" [ref=e134] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e135]:
