...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> institutions-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  334988 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: institutions-delete-desktop.png

Call log:
  - Expect "toHaveScreenshot(institutions-delete-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - list [ref=e61]:
        ...
        - listitem [ref=e70]: / Potwierdź usuwanie
      - generic [ref=e72]:
      ...
      - heading [level=2] [ref=e76]:
        - link ",,KOMBUD” Sp. z o. o." [ref=e78] [cursor=pointer]:
          - /url: /instytucje/kombud-sp-z-o-o
      - generic [ref=e79]:
        - text: Czy na pewno chcesz usunąć ",,KOMBUD” Sp. z o. o."?
        - button "Usuń" [ref=e81] [cursor=pointer]
      - generic [ref=e82]:
        - generic [ref=e83]:
  ...
  - list [ref=e95]:
    ...
    - listitem [ref=e102]:
      ...
      - link "Historia /instytucje/kombud-sp-z-o-o/~usun" [ref=e104] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e105]:
    ...
    - listitem [ref=e108]:
      ...
      - 'link "Czas CPU: 80.28ms (83.65ms)" [ref=e110] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e111]:
    ...
    - listitem [ref=e117]:
      ...
      - link "Zapytania InstitutionDeleteView" [ref=e119] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e120]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e121]
      - link "SQL 7 queries in 3.32ms" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
    ...
    - listitem [ref=e126]:
      ...
      - link "Templatki institutions/institution_confirm_delete.html" [ref=e128] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e129]:
    ...
    - listitem [ref=e132]:
      ...
      - link "Cache 2 wywołania w 0.14ms" [ref=e134] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e135]:
