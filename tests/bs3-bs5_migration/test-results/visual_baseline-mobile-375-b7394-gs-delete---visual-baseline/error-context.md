...
- Name: visual_baseline.spec.ts >> mobile (375px) >> casetags-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 812px, received 383px by 812px. 169498 pixels (ratio 0.55 of all image pixels) are different.

  Snapshot: casetags-delete-mobile.png

Call log:
  - Expect "toHaveScreenshot(casetags-delete-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e84]:
        - text: Czy na pewno chcesz usunąć "procedury z wolnej ręki i dotacji"?
        - button "Usuń" [ref=e86] [cursor=pointer]
      - generic [ref=e87]:
        - generic [ref=e88]:
  ...
  - list [ref=e100]:
    ...
    - listitem [ref=e107]:
      ...
      - link "Historia /sprawy/tagi/monitoring-44/2/~delete" [ref=e109] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e110]:
    ...
    - listitem [ref=e113]:
      ...
      - 'link "Czas CPU: 84.20ms (86.63ms)" [ref=e115] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e116]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Zapytania TagDeleteView" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e126]
      - link "SQL 8 queries in 2.69ms" [ref=e127] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e128]:
    ...
    - listitem [ref=e131]:
      ...
      - link "Templatki cases_tags/tag_confirm_delete.html" [ref=e133] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e134]:
    ...
    - listitem [ref=e137]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e139] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e140]:
