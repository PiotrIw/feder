...
- Name: visual_baseline.spec.ts >> mobile (375px) >> parcels-incoming-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 817px, received 375px by 812px. 172819 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: parcels-incoming-delete-mobile.png

Call log:
  - Expect "toHaveScreenshot(parcels-incoming-delete-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        - listitem [ref=e70]:
          - link "Monitoring mediów samorządowych" [ref=e71] [cursor=pointer]:
            - /url: /monitoringi/monitoring-mediow-samorzadowych
        - listitem [ref=e72]:
          - text: /
          - 'link "Monitoring mediów samorządowych #525" [ref=e73] [cursor=pointer]':
            - /url: /sprawy/monitoring-mediow-samorzadowych-525
        - listitem [ref=e74]: / Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl
      - generic [ref=e76]:
      ...
      - heading [level=2] [ref=e80]:
        - link "Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl" [ref=e82] [cursor=pointer]:
          - /url: /przesylki/incoming-1
      - generic [ref=e83]:
        - text: Czy na pewno chcesz usunąć "Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl"?
        - button "Usuń" [ref=e85] [cursor=pointer]
      - generic [ref=e86]:
        - generic [ref=e87]:
          - text: Sieć Obywatelska - Watchdog Polska ul. Szpitalna 5/5 00-031 Warszawa
          - paragraph [ref=e88]:
            - link "Klauzula RODO" [ref=e89] [cursor=pointer]:
              - /url: https://fedrowanie.siecobywatelska.pl/media_internal/tinycontent/uploads/11_KLAUZULA.-.dane.z.udip.na.stronach.www.i.w.mediach.spol.pdf
        - generic [ref=e90]:
          - text: "silnik:"
          - link "jawne.info.pl" [ref=e91] [cursor=pointer]:
            - /url: http://jawne.info.pl
          - text: "| v1.5.77.deps |"
          - link "GitHub" [ref=e92] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder
          - text: –
          - link "efd8a3b" [ref=e94] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder/compare/efd8a3b2...master
          - text: "|"
          - link "API" [ref=e95] [cursor=pointer]:
            - /url: /api/
        - generic [ref=e97]: Ta strona wykorzystuje cookies.
  - list [ref=e99]:
    - listitem [ref=e100]:
      - link "Ukryj »" [ref=e101] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e102]:
      - link "Toggle Theme" [ref=e103] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e106]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e107]
      - link "Historia /przesylki/incoming-1/~delete" [ref=e108] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e109]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e110]
      - link "Wersje Django 5.2.17" [ref=e111] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e112]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e113]
      - 'link "Czas CPU: 247.10ms (244.63ms)" [ref=e114] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e115]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e116]
      - link "Ustawienia" [ref=e117] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e118]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e119]
      - link "Nagłówki" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e122]
      - link "Zapytania IncomingParcelPostDeleteView" [ref=e123] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e124]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e125]
      - link "SQL 9 queries in 6.37ms" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e128]
      - link "Pliki statyczne 3 użyte plików" [ref=e129] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e130]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e131]
      - link "Templatki parcels/incomingparcelpost_confirm_delete.html" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e134]
      - link "Alerty" [ref=e135] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e136]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e137]
      - link "Cache 2 wywołania w 0.12ms" [ref=e138] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e139]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e140]
      - link "Sygnały 88 odbiorców 15 sygnałów" [ref=e141] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e142]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e143]
      - link "Gmina" [ref=e144] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e145]:
      - checkbox "Enable for next and successive requests" [ref=e146]
      - generic [ref=e147]: Przechwycone przekierowania
    - listitem [ref=e148]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e149]
      - link "Profilowanie" [ref=e150] [cursor=pointer]:
        - /url: "#"
```
