...
- Name: visual_baseline.spec.ts >> mobile (375px) >> cases-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 812px, received 383px by 812px. 172912 pixels (ratio 0.56 of all image pixels) are different.

  Snapshot: cases-delete-mobile.png

Call log:
  - Expect "toHaveScreenshot(cases-delete-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e70]:
        ...
        - button "Dodaj przesyłkę pocztową" [ref=e75] [cursor=pointer]
        - link "Dodaj list" [ref=e77] [cursor=pointer]:
          - /url: /listy/~utworz-2684
      - 'heading "Monitoring sądów apelacyjnych #1" [level=1] [ref=e80]'
      - generic [ref=e83]:
        - text: "Czy na pewno chcesz usunąć \"Monitoring sądów apelacyjnych #1\"?"
  ...
  - list [ref=e99]:
    ...
    - listitem [ref=e106]:
      ...
      - link "Historia /sprawy/monitoring-sadow-apelacyjnych-1/~usun" [ref=e108] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e112]:
      ...
      - 'link "Czas CPU: 261.96ms (254.83ms)" [ref=e114] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e121]:
      ...
      - link "Zapytania CaseDeleteView" [ref=e123] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e124]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e125]
      - link "SQL 10 queries in 3.83ms" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
    ...
    - listitem [ref=e130]:
      ...
      - link "Templatki cases/case_confirm_delete.html" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
    ...
    - listitem [ref=e136]:
      ...
      - link "Cache 2 wywołania w 0.17ms" [ref=e138] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e139]:
