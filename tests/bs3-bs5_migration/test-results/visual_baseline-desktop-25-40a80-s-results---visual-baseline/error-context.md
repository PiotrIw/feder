...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> monitorings-results - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  373060 pixels (ratio 0.11 of all image pixels) are different.

  Snapshot: monitorings-results-desktop.png

Call log:
  - Expect "toHaveScreenshot(monitorings-results-desktop.png)" with timeout 5000ms
      ...
      - generic [ref=e87]:
        ...
        - generic [ref=e182]:
          - list [ref=e183]:
            ...
            - listitem [ref=e192]:
              - generic [ref=e193]: Wyniki
          - heading "Wyniki" [level=3] [ref=e194]
          - generic [ref=e195]:
            - heading "Temat e-mail" [level=5] [ref=e196]
            - generic [ref=e197]: Wniosek o udostępnienie informacji publicznej
            - heading "Podsumowanie wyników" [level=5] [ref=e200]
            - generic [ref=e202]:
              - paragraph
      - generic [ref=e203]:
        - generic [ref=e204]:
          ...
          - paragraph [ref=e205]:
            - link "Klauzula RODO" [ref=e206] [cursor=pointer]:
              - /url: https://fedrowanie.siecobywatelska.pl/media_internal/tinycontent/uploads/11_KLAUZULA.-.dane.z.udip.na.stronach.www.i.w.mediach.spol.pdf
        - generic [ref=e207]:
          - text: "silnik:"
          - link "jawne.info.pl" [ref=e208] [cursor=pointer]:
            - /url: http://jawne.info.pl
          - text: "| v1.5.77.deps |"
          - link "GitHub" [ref=e209] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder
          - text: –
          - link "efd8a3b" [ref=e211] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder/compare/efd8a3b2...master
          - text: "|"
          - link "API" [ref=e212] [cursor=pointer]:
            - /url: /api/
        - generic [ref=e214]: Ta strona wykorzystuje cookies.
  - list [ref=e216]:
    - listitem [ref=e217]:
      - link "Ukryj »" [ref=e218] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e219]:
      - link "Toggle Theme" [ref=e220] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e223]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e224]
      - link "Historia /monitoringi/monitoring-sadow-apelacyjnych/results" [ref=e225] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e226]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e227]
      - link "Wersje Django 5.2.17" [ref=e228] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e229]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e230]
      - 'link "Czas CPU: 251.89ms (242.40ms)" [ref=e231] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e232]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e233]
      - link "Ustawienia" [ref=e234] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e235]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e236]
      - link "Nagłówki" [ref=e237] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e238]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e239]
      - link "Zapytania MonitoringResultsView" [ref=e240] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e241]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e242]
      - link "SQL 60 queries in 29.73ms" [ref=e243] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e244]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e245]
      - link "Pliki statyczne 3 użyte plików" [ref=e246] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e247]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e248]
      - link "Templatki monitorings/monitoring_results.html" [ref=e249] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e250]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e251]
      - link "Alerty" [ref=e252] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e253]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e254]
      - link "Cache 2 wywołania w 0.12ms" [ref=e255] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e256]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e257]
      - link "Sygnały 88 odbiorców 15 sygnałów" [ref=e258] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e259]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e260]
      - link "Gmina" [ref=e261] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e262]:
      - checkbox "Enable for next and successive requests" [ref=e263]
      - generic [ref=e264]: Przechwycone przekierowania
    - listitem [ref=e265]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e266]
      - link "Profilowanie" [ref=e267] [cursor=pointer]:
        - /url: "#"
```
