...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> account-change-password - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  334859 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: account-change-password-desktop.png

Call log:
  - Expect "toHaveScreenshot(account-change-password-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - generic [ref=e63]:
        ...
        - generic [ref=e65]:
          - generic [ref=e66]:
            - generic [ref=e67]: Obecne hasło*
            - textbox "Obecne hasło*" [ref=e68]:
              - /placeholder: Obecne hasło
            - link "Zapomniałeś hasła?" [ref=e70] [cursor=pointer]:
              - /url: /accounts/password/reset/
          - generic [ref=e71]:
            - generic [ref=e72]: Nowe hasło*
            - textbox "Nowe hasło*" [ref=e73]:
              - /placeholder: Nowe hasło
          - generic [ref=e74]:
            - generic [ref=e75]: Nowe hasło (ponownie)*
            - textbox "Nowe hasło (ponownie)*" [ref=e76]:
              - /placeholder: Nowe hasło (ponownie)
          - button "Zmień hasło" [ref=e77] [cursor=pointer]
      - generic [ref=e78]:
        - generic [ref=e79]:
  ...
  - list [ref=e91]:
    ...
    - listitem [ref=e98]:
      ...
      - link "Historia /accounts/password/change/" [ref=e100] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e101]:
    ...
    - listitem [ref=e104]:
      ...
      - 'link "Czas CPU: 85.11ms (86.52ms)" [ref=e106] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e107]:
    ...
    - listitem [ref=e113]:
      ...
      - link "Zapytania PasswordChangeView" [ref=e115] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e116]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e117]
      - link "SQL 4 queries in 0.96ms" [ref=e118] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e119]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Templatki account/password_change.html" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
    ...
    - listitem [ref=e128]:
      ...
      - link "Cache 2 wywołania w 0.14ms" [ref=e130] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e131]:
