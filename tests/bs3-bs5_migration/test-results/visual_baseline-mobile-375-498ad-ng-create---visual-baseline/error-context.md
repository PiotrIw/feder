...
- Name: visual_baseline.spec.ts >> mobile (375px) >> parcels-incoming-create - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 955px, received 375px by 964px. 172793 pixels (ratio 0.48 of all image pixels) are different.

  Snapshot: parcels-incoming-create-mobile.png

Call log:
  - Expect "toHaveScreenshot(parcels-incoming-create-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e74]: / Dodaj przychodzącą przesyłkę pocztową
      - heading "Dodaj przychodzącą przesyłkę pocztową" [level=2] [ref=e76]
      - generic [ref=e79]:
        - generic [ref=e80]:
  ...
  - list [ref=e113]:
    ...
    - listitem [ref=e120]:
      ...
      - link "Historia /przesylki/~create-incoming-2684" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
    ...
    - listitem [ref=e126]:
      ...
      - 'link "Czas CPU: 110.08ms (112.26ms)" [ref=e128] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e129]:
    ...
    - listitem [ref=e135]:
      ...
      - link "Zapytania IncomingParcelPostCreateView" [ref=e137] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e138]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e139]
      - link "SQL 7 queries in 2.28ms" [ref=e140] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e141]:
    ...
    - listitem [ref=e144]:
      ...
      - link "Templatki parcels/incomingparcelpost_form.html" [ref=e146] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e147]:
    ...
    - listitem [ref=e150]:
      ...
      - link "Cache 2 wywołania w 0.15ms" [ref=e152] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e153]:
