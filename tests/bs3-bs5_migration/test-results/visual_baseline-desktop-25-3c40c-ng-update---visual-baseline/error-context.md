...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> parcels-incoming-update - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  355755 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: parcels-incoming-update-desktop.png

Call log:
  - Expect "toHaveScreenshot(parcels-incoming-update-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - list [ref=e61]:
        ...
        - listitem [ref=e66]:
          - text: /
          - link "Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl" [ref=e67] [cursor=pointer]:
            - /url: /przesylki/incoming-1
        - listitem [ref=e68]: / Zaktualizuj przychodzącą przesyłkę pocztową
      - generic [ref=e70]:
      ...
      - heading [level=2] [ref=e74]:
        - link "Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl" [ref=e76] [cursor=pointer]:
          - /url: /przesylki/incoming-1
      - generic [ref=e78]:
        - generic [ref=e79]:
          - generic [ref=e80]: Tytuł*
          - textbox "Tytuł*" [ref=e81]: Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl
        - generic [ref=e82]:
          - generic [ref=e83]: Treść*
          - generic [ref=e84]:
            - generic [ref=e85]: Teraz
            - link "odpowiedź_na_informację_publiczną.docx" [ref=e88] [cursor=pointer]:
              - /url: /media/odpowied%C5%BA_na_informacj%C4%99_publiczn%C4%85.docx
          - button "Treść*" [ref=e90] [cursor=pointer]
        - generic [ref=e91]:
          - generic [ref=e92]: Nadawca*
          - combobox [aria-hidden] [ref=e93]
          - combobox [ref=e96] [cursor=pointer]:
            - textbox "ŻYRZYN" [ref=e97]
        - generic [ref=e98]:
          - generic [ref=e99]: Data odbioru*
          - textbox "Data odbioru*" [ref=e100]: 25.07.2018
  ...
  - list [ref=e117]:
    ...
    - listitem [ref=e124]:
      ...
      - link "Historia /przesylki/incoming-1/~update" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
    ...
    - listitem [ref=e130]:
      ...
      - 'link "Czas CPU: 275.23ms (278.35ms)" [ref=e132] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e133]:
    ...
    - listitem [ref=e139]:
      ...
      - link "Zapytania IncomingParcelPostUpdateView" [ref=e141] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e142]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e143]
      - link "SQL 11 queries in 3.69ms" [ref=e144] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e145]:
    ...
    - listitem [ref=e148]:
      ...
      - link "Templatki parcels/incomingparcelpost_form.html" [ref=e150] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e151]:
    ...
    - listitem [ref=e154]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e156] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e157]:
