...
- Name: visual_baseline.spec.ts >> mobile (375px) >> letters-unrecognized-list - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 455px by 1877px, received 503px by 1869px. 238887 pixels (ratio 0.26 of all image pixels) are different.

  Snapshot: letters-unrecognized-list-mobile.png

Call log:
  - Expect "toHaveScreenshot(letters-unrecognized-list-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e234]:
    ...
    - listitem [ref=e247]:
      ...
      - 'link "Czas CPU: 582.69ms (1780.20ms)" [ref=e249] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e250]:
    ...
    - listitem [ref=e259]:
      ...
      - link "SQL 20 queries in 1418.68ms" [ref=e261] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e262]:
    ...
    - listitem [ref=e271]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e273] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e274]:
