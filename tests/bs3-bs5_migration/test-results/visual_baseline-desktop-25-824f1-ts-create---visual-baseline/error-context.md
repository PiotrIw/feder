...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> alerts-create - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  328709 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: alerts-create-desktop.png

Call log:
  - Expect "toHaveScreenshot(alerts-create-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - list [ref=e61]:
        ...
        - listitem [ref=e64]: / Dodaj alert
      - generic [ref=e67]:
        - generic [ref=e68]:
          - generic [ref=e69]: Przyczyna*
          - textbox "Przyczyna*" [ref=e70]
        - button "Zapisz" [ref=e73] [cursor=pointer]
      - generic [ref=e74]:
        - generic [ref=e75]:
  ...
  - list [ref=e87]:
    ...
    - listitem [ref=e94]:
      ...
      - link "Historia /alerty/monitoring-4/~create" [ref=e96] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e97]:
    ...
    - listitem [ref=e100]:
      ...
      - 'link "Czas CPU: 232.38ms (229.52ms)" [ref=e102] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e103]:
    ...
    - listitem [ref=e109]:
      ...
      - link "Zapytania AlertCreateView" [ref=e111] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e112]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e113]
      - link "SQL 5 queries in 1.42ms" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - link "Templatki alerts/alert_form.html" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
