...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> account-email-verification-sent - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  334726 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: account-email-verification-sent-desktop.png

Call log:
  - Expect "toHaveScreenshot(account-email-verification-sent-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - generic [ref=e63]:
        - heading "Zweryfikuj swój adres e-mail" [level=2] [ref=e64]
        - paragraph [ref=e65]:
  ...
  - list [ref=e79]:
    ...
    - listitem [ref=e86]:
      ...
      - link "Historia /accounts/confirm-email/" [ref=e88] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e89]:
    ...
    - listitem [ref=e92]:
      ...
      - 'link "Czas CPU: 57.97ms (59.21ms)" [ref=e94] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e95]:
    ...
    - listitem [ref=e101]:
      ...
      - link "Zapytania email_verification_sent" [ref=e103] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e104]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e105]
      - link "SQL 4 queries in 1.14ms" [ref=e106] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e107]:
    ...
    - listitem [ref=e110]:
      ...
      - link "Templatki account/verification_sent.html" [ref=e112] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e113]:
