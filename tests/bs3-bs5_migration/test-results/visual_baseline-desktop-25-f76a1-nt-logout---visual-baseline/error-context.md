...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> account-logout - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  333485 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: account-logout-desktop.png

Call log:
  - Expect "toHaveScreenshot(account-logout-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - generic [ref=e63]:
        - heading "Wyloguj się" [level=2] [ref=e64]
        - paragraph [ref=e65]: Jesteś pewny, że chcesz się wylogować ?
        - button "Wyloguj się" [ref=e67] [cursor=pointer]
      - generic [ref=e68]:
        - generic [ref=e69]:
  ...
  - list [ref=e81]:
    ...
    - listitem [ref=e88]:
      ...
      - link "Historia /accounts/logout/" [ref=e90] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e91]:
    ...
    - listitem [ref=e94]:
      ...
      - 'link "Czas CPU: 56.48ms (58.01ms)" [ref=e96] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e97]:
    ...
    - listitem [ref=e103]:
      ...
      - link "Zapytania LogoutView" [ref=e105] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e106]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e107]
      - link "SQL 4 queries in 1.11ms" [ref=e108] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e112]:
      ...
      - link "Templatki account/logout.html" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
