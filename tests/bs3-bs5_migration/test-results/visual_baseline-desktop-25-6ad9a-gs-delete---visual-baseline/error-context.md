...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> casetags-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  337768 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: casetags-delete-desktop.png

Call log:
  - Expect "toHaveScreenshot(casetags-delete-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      ...
      - generic [ref=e76]:
        ...
        - button "Usuń" [ref=e78] [cursor=pointer]
      - generic [ref=e79]:
        - generic [ref=e80]:
  ...
  - list [ref=e92]:
    ...
    - listitem [ref=e99]:
      ...
      - link "Historia /sprawy/tagi/monitoring-44/2/~delete" [ref=e101] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e102]:
    ...
    - listitem [ref=e105]:
      ...
      - 'link "Czas CPU: 78.76ms (82.05ms)" [ref=e107] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e108]:
    ...
    - listitem [ref=e114]:
      ...
      - link "Zapytania TagDeleteView" [ref=e116] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e117]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e118]
      - link "SQL 8 queries in 3.40ms" [ref=e119] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e120]:
    ...
    - listitem [ref=e123]:
      ...
      - link "Templatki cases_tags/tag_confirm_delete.html" [ref=e125] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e126]:
    ...
    - listitem [ref=e129]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e131] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e132]:
