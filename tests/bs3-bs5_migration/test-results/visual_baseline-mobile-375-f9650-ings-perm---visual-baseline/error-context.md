...
- Name: visual_baseline.spec.ts >> mobile (375px) >> monitorings-perm - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 430px by 1700px, received 431px by 1882px. 199594 pixels (ratio 0.25 of all image pixels) are different.

  Snapshot: monitorings-perm-mobile.png

Call log:
  - Expect "toHaveScreenshot(monitorings-perm-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e231]:
    ...
    - listitem [ref=e244]:
      ...
      - 'link "Czas CPU: 85.11ms (88.21ms)" [ref=e246] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e247]:
    ...
    - listitem [ref=e256]:
      ...
      - link "SQL 8 queries in 3.31ms" [ref=e258] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e259]:
