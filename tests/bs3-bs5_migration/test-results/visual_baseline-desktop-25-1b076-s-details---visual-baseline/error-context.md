...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> alerts-details - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  338680 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: alerts-details-desktop.png

Call log:
  - Expect "toHaveScreenshot(alerts-details-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
    ...
    - generic [ref=e60]:
      ...
      - generic [ref=e76]:
        - table [ref=e77]:
          - rowgroup [ref=e78]:
            - row [ref=e79]:
              - cell "Data utworzenia" [ref=e80]
              - cell "18 października 2017 22:41" [ref=e81]
            - row [ref=e82]:
              - cell "Data modyfikacji" [ref=e83]
              - cell "18 października 2017 22:41" [ref=e84]
            - row [ref=e85]:
              - cell "Autor" [ref=e86]
              - cell "None" [ref=e87]
            - row [ref=e88]:
              - cell "Status" [ref=e89]
              - cell "Zamknięte" [ref=e90]
        - paragraph [ref=e91]: SPAM
      - generic [ref=e92]:
        - generic [ref=e93]:
  ...
  - list [ref=e105]:
    ...
    - listitem [ref=e112]:
      ...
      - link "Historia /alerty/1" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - 'link "Czas CPU: 75.73ms (78.49ms)" [ref=e120] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e121]:
    ...
    - listitem [ref=e127]:
      ...
      - link "Zapytania AlertDetailView" [ref=e129] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e130]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e131]
      - link "SQL 8 queries in 2.92ms" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
    ...
    - listitem [ref=e136]:
      ...
      - link "Templatki alerts/alert_detail.html" [ref=e138] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e139]:
    ...
    - listitem [ref=e142]:
      ...
      - link "Cache 2 wywołania w 0.22ms" [ref=e144] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e145]:
