...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> letters-resend - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  357942 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: letters-resend-desktop.png

Call log:
  - Expect "toHaveScreenshot(letters-resend-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
    ...
    - generic [ref=e60]:
      - list [ref=e61]:
        ...
        - listitem [ref=e66]:
          ...
          - link "Wniosek o udostępnienie informacji publicznej" [ref=e67] [cursor=pointer]:
            - /url: /listy/7302
        - listitem [ref=e68]: / Wyślij ponownie list
      - generic [ref=e72]:
      ...
      - generic [ref=e80]:
        ...
        - generic [ref=e90]:
          ...
          - button "Resend letter" [ref=e92] [cursor=pointer]
      - generic [ref=e93]:
        - generic [ref=e94]:
  ...
  - list [ref=e106]:
    ...
    - listitem [ref=e113]:
      ...
      - link "Historia /listy/7302/~resend" [ref=e115] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e116]:
    ...
    - listitem [ref=e119]:
      ...
      - 'link "Czas CPU: 96.82ms (99.77ms)" [ref=e121] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e122]:
    ...
    - listitem [ref=e128]:
      ...
      - link "Zapytania LetterResendView" [ref=e130] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e131]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e132]
      - link "SQL 8 queries in 3.59ms" [ref=e133] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e134]:
    ...
    - listitem [ref=e137]:
      ...
      - link "Templatki letters/letter_resend.html" [ref=e139] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e140]:
