...
- Name: visual_baseline.spec.ts >> mobile (375px) >> letters-logs-list-monitoring - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 541px by 1106px, received 601px by 981px. 180269 pixels (ratio 0.28 of all image pixels) are different.

  Snapshot: letters-logs-list-monitoring-mobile.png

Call log:
  - Expect "toHaveScreenshot(letters-logs-list-monitoring-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e136]:
    ...
    - listitem [ref=e149]:
      ...
      - 'link "Czas CPU: 98.28ms (101.55ms)" [ref=e151] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e152]:
    ...
    - listitem [ref=e161]:
      ...
      - link "SQL 10 queries in 3.63ms" [ref=e163] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e164]:
    ...
    - listitem [ref=e173]:
      ...
      - link "Cache 2 wywołania w 0.14ms" [ref=e175] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e176]:
