...
- Name: visual_baseline.spec.ts >> mobile (375px) >> casetags-update - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 812px, received 383px by 812px. 170720 pixels (ratio 0.55 of all image pixels) are different.

  Snapshot: casetags-update-mobile.png

Call log:
  - Expect "toHaveScreenshot(casetags-update-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e85]:
        - generic [ref=e86]:
          - generic [ref=e87]: Nazwa*
          - textbox "Nazwa*" [ref=e88]: procedury z wolnej ręki i dotacji
  ...
  - list [ref=e105]:
    ...
    - listitem [ref=e112]:
      ...
      - link "Historia /sprawy/tagi/monitoring-44/2/~update" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - 'link "Czas CPU: 88.24ms (91.11ms)" [ref=e120] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e121]:
    ...
    - listitem [ref=e127]:
      ...
      - link "Zapytania TagUpdateView" [ref=e129] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e130]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e131]
      - link "SQL 8 queries in 3.09ms" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
    ...
    - listitem [ref=e136]:
      ...
      - link "Templatki cases_tags/tag_form.html" [ref=e138] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e139]:
    ...
    - listitem [ref=e142]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e144] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e145]:
