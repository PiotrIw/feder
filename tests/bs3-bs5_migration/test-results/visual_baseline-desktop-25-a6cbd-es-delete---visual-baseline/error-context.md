...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> cases-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  340855 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: cases-delete-desktop.png

Call log:
  - Expect "toHaveScreenshot(cases-delete-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - generic [ref=e62]:
        - link "Edytuj" [ref=e63] [cursor=pointer]:
          - /url: /sprawy/monitoring-sadow-apelacyjnych-1/~edytuj
        - link "Usuń" [ref=e64] [cursor=pointer]:
          - /url: /sprawy/monitoring-sadow-apelacyjnych-1/~usun
        - link "Zobacz dzienniki" [ref=e65] [cursor=pointer]:
          - /url: /listy/logi/spraw-2684
        - button "Dodaj przesyłkę pocztową" [ref=e67] [cursor=pointer]
        - link "Dodaj list" [ref=e69] [cursor=pointer]:
          - /url: /listy/~utworz-2684
      - 'heading "Monitoring sądów apelacyjnych #1" [level=1] [ref=e72]'
      - generic [ref=e75]:
  ...
  - list [ref=e91]:
    ...
    - listitem [ref=e98]:
      ...
      - link "Historia /sprawy/monitoring-sadow-apelacyjnych-1/~usun" [ref=e100] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e101]:
    ...
    - listitem [ref=e104]:
      ...
      - 'link "Czas CPU: 89.19ms (92.28ms)" [ref=e106] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e107]:
    ...
    - listitem [ref=e113]:
      ...
      - link "Zapytania CaseDeleteView" [ref=e115] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e116]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e117]
      - link "SQL 10 queries in 3.69ms" [ref=e118] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e119]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Templatki cases/case_confirm_delete.html" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
