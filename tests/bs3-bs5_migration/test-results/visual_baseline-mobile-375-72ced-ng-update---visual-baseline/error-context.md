...
- Name: visual_baseline.spec.ts >> mobile (375px) >> parcels-incoming-update - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 1142px, received 375px by 1154px. 175096 pixels (ratio 0.41 of all image pixels) are different.

  Snapshot: parcels-incoming-update-mobile.png

Call log:
  - Expect "toHaveScreenshot(parcels-incoming-update-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e74]:
          - text: /
          - link "Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl" [ref=e75] [cursor=pointer]:
            - /url: /przesylki/incoming-1
        - listitem [ref=e76]: / Zaktualizuj przychodzącą przesyłkę pocztową
      - generic [ref=e78]:
      ...
      - heading [level=2] [ref=e82]:
        - link "Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl" [ref=e84] [cursor=pointer]:
          - /url: /przesylki/incoming-1
      - generic [ref=e86]:
        - generic [ref=e87]:
          - generic [ref=e88]: Tytuł*
          - textbox "Tytuł*" [ref=e89]: Odpowiedź otrzynmana na adres biuro@siecobywatelska.pl
        - generic [ref=e90]:
          - generic [ref=e91]: Treść*
          - generic [ref=e92]:
            - generic [ref=e93]: Teraz
            - link "odpowiedź_na_informację_publiczną.docx" [ref=e96] [cursor=pointer]:
              - /url: /media/odpowied%C5%BA_na_informacj%C4%99_publiczn%C4%85.docx
          - button "Treść*" [ref=e98] [cursor=pointer]
        - generic [ref=e99]:
          - generic [ref=e100]: Nadawca*
          - combobox [aria-hidden] [ref=e101]
          - combobox [ref=e104] [cursor=pointer]:
            - textbox "ŻYRZYN" [ref=e105]
        - generic [ref=e106]:
          - generic [ref=e107]: Data odbioru*
          - textbox "Data odbioru*" [ref=e108]: 25.07.2018
  ...
  - list [ref=e125]:
    ...
    - listitem [ref=e132]:
      ...
      - link "Historia /przesylki/incoming-1/~update" [ref=e134] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e135]:
    ...
    - listitem [ref=e138]:
      ...
      - 'link "Czas CPU: 125.27ms (124.70ms)" [ref=e140] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e141]:
    ...
    - listitem [ref=e147]:
      ...
      - link "Zapytania IncomingParcelPostUpdateView" [ref=e149] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e150]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e151]
      - link "SQL 11 queries in 3.34ms" [ref=e152] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e153]:
    ...
    - listitem [ref=e156]:
      ...
      - link "Templatki parcels/incomingparcelpost_form.html" [ref=e158] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e159]:
