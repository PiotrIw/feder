...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> alerts-update - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  337264 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: alerts-update-desktop.png

Call log:
  - Expect "toHaveScreenshot(alerts-update-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      ...
      - generic [ref=e77]:
        - generic [ref=e78]:
          - generic [ref=e79]: Przyczyna*
          - textbox "Przyczyna*" [ref=e80]: SPAM
  ...
  - list [ref=e97]:
    ...
    - listitem [ref=e104]:
      ...
      - link "Historia /alerty/1/~aktualizuj" [ref=e106] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e107]:
    ...
    - listitem [ref=e110]:
      ...
      - 'link "Czas CPU: 89.00ms (91.98ms)" [ref=e112] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e113]:
    ...
    - listitem [ref=e119]:
      ...
      - link "Zapytania AlertUpdateView" [ref=e121] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e122]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e123]
      - link "SQL 9 queries in 3.18ms" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
    ...
    - listitem [ref=e128]:
      ...
      - link "Templatki alerts/alert_form.html" [ref=e130] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e131]:
