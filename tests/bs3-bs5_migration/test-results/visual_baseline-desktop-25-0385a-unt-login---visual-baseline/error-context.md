...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> account-login - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  337444 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: account-login-desktop.png

Call log:
  - Expect "toHaveScreenshot(account-login-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e85]:
    ...
    - listitem [ref=e98]:
      ...
      - 'link "Czas CPU: 79.89ms (74.67ms)" [ref=e100] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e101]:
    ...
    - listitem [ref=e110]:
      ...
      - link "SQL 7 queries in 3.00ms" [ref=e112] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e113]:
