...
- Name: visual_baseline.spec.ts >> mobile (375px) >> users-update - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  172824 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: users-update-mobile.png

Call log:
  - Expect "toHaveScreenshot(users-update-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e71]:
        - 'heading "Użytkownik / użytkowniczka: claude_ai" [level=1] [ref=e72]'
        - generic [ref=e73]:
          - generic [ref=e74]:
            - generic [ref=e75]: Imię
            - textbox "Imię" [ref=e76]
          - generic [ref=e77]:
            - generic [ref=e78]: Nazwisko
            - textbox "Nazwisko" [ref=e79]
          - button "Aktualizuj" [ref=e81] [cursor=pointer]
      - generic [ref=e82]:
        - generic [ref=e83]:
  ...
  - list [ref=e95]:
    ...
    - listitem [ref=e102]:
      ...
      - link "Historia /uzytkownik/~aktualizuj/" [ref=e104] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e105]:
    ...
    - listitem [ref=e108]:
      ...
      - 'link "Czas CPU: 79.81ms (81.45ms)" [ref=e110] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e111]:
    ...
    - listitem [ref=e117]:
      ...
      - link "Zapytania UserUpdateView" [ref=e119] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e120]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e121]
      - link "SQL 5 queries in 1.44ms" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
    ...
    - listitem [ref=e126]:
      ...
      - link "Templatki users/user_form.html" [ref=e128] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e129]:
    ...
    - listitem [ref=e132]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e134] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e135]:
