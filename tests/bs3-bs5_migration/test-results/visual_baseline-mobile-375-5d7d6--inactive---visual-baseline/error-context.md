...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-inactive - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  168371 pixels (ratio 0.56 of all image pixels) are different.

  Snapshot: account-inactive-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-inactive-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e16]:
    ...
    - listitem [ref=e29]:
      ...
      - 'link "Czas CPU: 40.32ms (41.83ms)" [ref=e31] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e32]:
    ...
    - listitem [ref=e41]:
      ...
      - link "SQL 4 queries in 1.04ms" [ref=e43] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e44]:
