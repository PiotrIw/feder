...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> alerts-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  339097 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: alerts-delete-desktop.png

Call log:
  - Expect "toHaveScreenshot(alerts-delete-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e92]:
    ...
    - listitem [ref=e99]:
      ...
      - link "Historia /alerty/1/~usun" [ref=e101] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e102]:
    ...
    - listitem [ref=e105]:
      ...
      - 'link "Czas CPU: 118.66ms (107.50ms)" [ref=e107] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e108]:
    ...
    - listitem [ref=e114]:
      ...
      - link "Zapytania AlertDeleteView" [ref=e116] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e117]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e118]
      - link "SQL 9 queries in 3.73ms" [ref=e119] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e120]:
    ...
    - listitem [ref=e123]:
      ...
      - link "Templatki alerts/alert_confirm_delete.html" [ref=e125] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e126]:
    ...
    - listitem [ref=e129]:
      ...
      - link "Cache 2 wywołania w 0.16ms" [ref=e131] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e132]:
