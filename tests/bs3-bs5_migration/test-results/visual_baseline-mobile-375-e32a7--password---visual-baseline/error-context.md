...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-reset-password - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  170027 pixels (ratio 0.56 of all image pixels) are different.

  Snapshot: account-reset-password-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-reset-password-mobile.png)" with timeout 5000ms
...
- generic [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e71]:
        - heading "Resetowanie hasła" [level=2] [ref=e72]
        - paragraph [ref=e73]:
          - strong [ref=e74]: "Uwaga:"
          - text: Jesteś już zalogowany/-a jako claude_ai.
        - paragraph [ref=e75]: Zapomniałeś swojego hasła? Wpisz swój adres e-mail poniżej, a my wyślemy Tobie wiadomość, dzięki której dokonasz jego zmiany.
        - generic [ref=e76]:
          - generic [ref=e77]:
            - generic [ref=e78]: Adres e-mail*
            - textbox "Adres e-mail*" [active] [ref=e79]:
              - /placeholder: Adres e-mail
          - button "Zresetuj moje hasło" [ref=e80] [cursor=pointer]
        - paragraph [ref=e81]: Skontaktuj się z nami, jeśli masz problem ze zresetowaniem swojego hasła.
      - generic [ref=e82]:
        - generic [ref=e83]:
          - text: Sieć Obywatelska - Watchdog Polska ul. Szpitalna 5/5 00-031 Warszawa
          - paragraph [ref=e84]:
            - link "Klauzula RODO" [ref=e85] [cursor=pointer]:
              - /url: https://fedrowanie.siecobywatelska.pl/media_internal/tinycontent/uploads/11_KLAUZULA.-.dane.z.udip.na.stronach.www.i.w.mediach.spol.pdf
        - generic [ref=e86]:
          - text: "silnik:"
          - link "jawne.info.pl" [ref=e87] [cursor=pointer]:
            - /url: http://jawne.info.pl
          - text: "| v1.5.77.deps |"
          - link "GitHub" [ref=e88] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder
          - text: –
          - link "efd8a3b" [ref=e90] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder/compare/efd8a3b2...master
          - text: "|"
          - link "API" [ref=e91] [cursor=pointer]:
            - /url: /api/
        - generic [ref=e93]: Ta strona wykorzystuje cookies.
  - list [ref=e95]:
    - listitem [ref=e96]:
      - link "Ukryj »" [ref=e97] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e98]:
      - link "Toggle Theme" [ref=e99] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e102]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e103]
      - link "Historia /accounts/password/reset/" [ref=e104] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e105]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e106]
      - link "Wersje Django 5.2.17" [ref=e107] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e108]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e109]
      - 'link "Czas CPU: 74.77ms (76.44ms)" [ref=e110] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e111]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e112]
      - link "Ustawienia" [ref=e113] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e114]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e115]
      - link "Nagłówki" [ref=e116] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e117]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e118]
      - link "Zapytania PasswordResetView" [ref=e119] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e120]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e121]
      - link "SQL 4 queries in 1.22ms" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e124]
      - link "Pliki statyczne 3 użyte plików" [ref=e125] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e126]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e127]
      - link "Templatki account/password_reset.html" [ref=e128] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e129]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e130]
      - link "Alerty" [ref=e131] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e132]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e133]
      - link "Cache 2 wywołania w 0.15ms" [ref=e134] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e135]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e136]
      - link "Sygnały 88 odbiorców 15 sygnałów" [ref=e137] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e138]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e139]
      - link "Gmina" [ref=e140] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e141]:
      - checkbox "Enable for next and successive requests" [ref=e142]
      - generic [ref=e143]: Przechwycone przekierowania
    - listitem [ref=e144]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e145]
      - link "Profilowanie" [ref=e146] [cursor=pointer]:
        - /url: "#"
```
