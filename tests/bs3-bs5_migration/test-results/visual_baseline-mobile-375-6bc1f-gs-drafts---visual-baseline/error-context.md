...
- Name: visual_baseline.spec.ts >> mobile (375px) >> monitorings-drafts - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 434px by 1811px, received 480px by 1710px. 184134 pixels (ratio 0.22 of all image pixels) are different.

  Snapshot: monitorings-drafts-mobile.png

Call log:
  - Expect "toHaveScreenshot(monitorings-drafts-mobile.png)" with timeout 5000ms
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e95]:
        ...
        - generic [ref=e190]:
          ...
          - heading "Projekty" [level=3] [ref=e202]
          - paragraph [ref=e204]: Brak wierszy.
      - generic [ref=e205]:
        - generic [ref=e206]:
          - text: Sieć Obywatelska - Watchdog Polska ul. Szpitalna 5/5 00-031 Warszawa
          - paragraph [ref=e207]:
            - link "Klauzula RODO" [ref=e208] [cursor=pointer]:
              - /url: https://fedrowanie.siecobywatelska.pl/media_internal/tinycontent/uploads/11_KLAUZULA.-.dane.z.udip.na.stronach.www.i.w.mediach.spol.pdf
        - generic [ref=e209]:
          - text: "silnik:"
          - link "jawne.info.pl" [ref=e210] [cursor=pointer]:
            - /url: http://jawne.info.pl
          - text: "| v1.5.77.deps |"
          - link "GitHub" [ref=e211] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder
          - text: –
          - link "efd8a3b" [ref=e213] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder/compare/efd8a3b2...master
          - text: "|"
          - link "API" [ref=e214] [cursor=pointer]:
            - /url: /api/
        - generic [ref=e216]: Ta strona wykorzystuje cookies.
  - list [ref=e218]:
    - listitem [ref=e219]:
      - link "Ukryj »" [ref=e220] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e221]:
      - link "Toggle Theme" [ref=e222] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e225]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e226]
      - link "Historia /monitoringi/monitoring-sadow-apelacyjnych/projekty" [ref=e227] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e228]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e229]
      - link "Wersje Django 5.2.17" [ref=e230] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e231]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e232]
      - 'link "Czas CPU: 557.66ms (4247.66ms)" [ref=e233] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e234]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e235]
      - link "Ustawienia" [ref=e236] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e237]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e238]
      - link "Nagłówki" [ref=e239] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e240]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e241]
      - link "Zapytania DraftListMonitoringView" [ref=e242] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e243]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e244]
      - link "SQL 60 queries in 4037.83ms" [ref=e245] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e246]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e247]
      - link "Pliki statyczne 3 użyte plików" [ref=e248] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e249]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e250]
      - link "Templatki monitorings/monitoring_draft_list.html" [ref=e251] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e252]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e253]
      - link "Alerty" [ref=e254] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e255]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e256]
      - link "Cache 2 wywołania w 0.13ms" [ref=e257] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e258]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e259]
      - link "Sygnały 88 odbiorców 15 sygnałów" [ref=e260] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e261]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e262]
      - link "Gmina" [ref=e263] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e264]:
      - checkbox "Enable for next and successive requests" [ref=e265]
      - generic [ref=e266]: Przechwycone przekierowania
    - listitem [ref=e267]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e268]
      - link "Profilowanie" [ref=e269] [cursor=pointer]:
        - /url: "#"
```
