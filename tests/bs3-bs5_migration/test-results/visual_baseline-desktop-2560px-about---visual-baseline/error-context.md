...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> about - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  376274 pixels (ratio 0.11 of all image pixels) are different.

  Snapshot: about-desktop.png

Call log:
  - Expect "toHaveScreenshot(about-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - generic [ref=e62]:
        - heading "O stronie Obywatelskie fedrowanie danych" [level=2] [ref=e63]
        - paragraph [ref=e64]: Do najważniejszych problemów debaty publicznej niewątpliwie zalicza się częste opieranie argumentacji na nieweryfikowalnych lub nieaktualnych danych.
        - paragraph [ref=e65]: Informacje posiadane przez organy administracji publicznej są skarbnicą wiedzy. Ich skuteczne wykorzystanie pozwoliłoby rozwiać wiele pojawiających się wątpliwości. Niestety, forma ich przechowywania i udostępniania często uniemożliwia łatwe ich odczytanie oraz intepretację, w szczególności przy użyciu technik cyfrowych.
        - paragraph [ref=e66]: Fedrowanie danych jest projektem powstałym w odpowiedzi na to wyzwanie. Ma na celu usystematyzowanie dużej liczby informacji spływających od instytucji publicznych oraz zapisanie ich w formie łatwej do analizy, zarówno przez człowieka, jak i maszynę. Zebrane i uporządkowane przy wsparciu AI dane służą następnie do przeprowadzania badań, które to przyczyniają się do wzrostu świadomości społecznej i poprawy jakości rządzenia.
        - paragraph [ref=e67]: Treści na stronie zorganizowane są poprzez monitoringi, które są grupą tematycznie powiązanych zapytań. Składają się one z wielu spraw, które tworzymy przed wysłaniem zapytania do dowolnego urzędu. Każda sprawa zawiera wiele listów wymienionych z danym urzędem.
      - generic [ref=e68]:
        - generic [ref=e69]:
  ...
  - list [ref=e81]:
    ...
    - listitem [ref=e88]:
      ...
      - link "Historia /o-stronie/" [ref=e90] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e91]:
    ...
    - listitem [ref=e94]:
      ...
      - 'link "Czas CPU: 63.34ms (65.49ms)" [ref=e96] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e97]:
    ...
    - listitem [ref=e103]:
      ...
      - link "Zapytania TemplateView" [ref=e105] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e106]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e107]
      - link "SQL 5 queries in 2.06ms" [ref=e108] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e112]:
      ...
      - link "Templatki pages/about.html" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - link "Cache 4 wywołania w 0.23ms" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
