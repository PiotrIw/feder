...
- Name: visual_baseline.spec.ts >> mobile (375px) >> alerts-create - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 812px, received 383px by 815px. 172613 pixels (ratio 0.55 of all image pixels) are different.

  Snapshot: alerts-create-mobile.png

Call log:
  - Expect "toHaveScreenshot(alerts-create-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e72]: / Dodaj alert
      - generic [ref=e75]:
        - generic [ref=e76]:
          - generic [ref=e77]: Przyczyna*
          - textbox "Przyczyna*" [ref=e78]
        - button "Zapisz" [ref=e81] [cursor=pointer]
      - generic [ref=e82]:
        - generic [ref=e83]:
  ...
  - list [ref=e95]:
    ...
    - listitem [ref=e102]:
      ...
      - link "Historia /alerty/monitoring-4/~create" [ref=e104] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e105]:
    ...
    - listitem [ref=e108]:
      ...
      - 'link "Czas CPU: 72.36ms (73.59ms)" [ref=e110] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e111]:
    ...
    - listitem [ref=e117]:
      ...
      - link "Zapytania AlertCreateView" [ref=e119] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e120]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e121]
      - link "SQL 5 queries in 1.28ms" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
    ...
    - listitem [ref=e126]:
      ...
      - link "Templatki alerts/alert_form.html" [ref=e128] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e129]:
