...
- Name: visual_baseline.spec.ts >> mobile (375px) >> institutions-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  172074 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: institutions-delete-mobile.png

Call log:
  - Expect "toHaveScreenshot(institutions-delete-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e78]: / Potwierdź usuwanie
      - generic [ref=e80]:
      ...
      - generic [ref=e87]:
        ...
        - button "Usuń" [ref=e89] [cursor=pointer]
      - generic [ref=e90]:
        - generic [ref=e91]:
  ...
  - list [ref=e103]:
    ...
    - listitem [ref=e110]:
      ...
      - link "Historia /instytucje/kombud-sp-z-o-o/~usun" [ref=e112] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e113]:
    ...
    - listitem [ref=e116]:
      ...
      - 'link "Czas CPU: 76.96ms (80.22ms)" [ref=e118] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e119]:
    ...
    - listitem [ref=e125]:
      ...
      - link "Zapytania InstitutionDeleteView" [ref=e127] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e128]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e129]
      - link "SQL 8 queries in 3.40ms" [ref=e130] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e131]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e132]
      - link "Pliki statyczne 3 użyte plików" [ref=e133] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e134]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e135]
      - link "Templatki institutions/institution_confirm_delete.html" [ref=e136] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e137]:
    ...
    - listitem [ref=e140]:
      ...
      - link "Cache 3 wywołania w 0.16ms" [ref=e142] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e143]:
