...
- Name: visual_baseline.spec.ts >> mobile (375px) >> monitorings-details - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 434px by 9953px, received 480px by 10527px. 419880 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: monitorings-details-mobile.png

Call log:
  - Expect "toHaveScreenshot(monitorings-details-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e720]:
    ...
    - listitem [ref=e733]:
      ...
      - 'link "Czas CPU: 432.34ms (465.21ms)" [ref=e735] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e736]:
    ...
    - listitem [ref=e745]:
      ...
      - link "SQL 92 queries in 49.46ms" [ref=e747] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e748]:
    ...
    - listitem [ref=e757]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e759] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e760]:
