...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> account-signup - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  337447 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: account-signup-desktop.png

Call log:
  - Expect "toHaveScreenshot(account-signup-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e85]:
    ...
    - listitem [ref=e98]:
      ...
      - 'link "Czas CPU: 75.68ms (70.91ms)" [ref=e100] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e101]:
    ...
    - listitem [ref=e110]:
      ...
      - link "SQL 7 queries in 2.45ms" [ref=e112] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e113]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
