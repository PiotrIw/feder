...
- Name: visual_baseline.spec.ts >> mobile (375px) >> parcels-outgoing-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 850px, received 375px by 852px. 169952 pixels (ratio 0.54 of all image pixels) are different.

  Snapshot: parcels-outgoing-delete-mobile.png

Call log:
  - Expect "toHaveScreenshot(parcels-outgoing-delete-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e83]:
        - text: Czy na pewno chcesz usunąć "Centrum Medyczne Ujastek w Krakowie (żywienie w szpitalach) - wniosek epuap30.10.2019"?
  ...
  - list [ref=e99]:
    ...
    - listitem [ref=e106]:
      ...
      - link "Historia /przesylki/outgoing-1/~delete" [ref=e108] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e112]:
      ...
      - 'link "Czas CPU: 91.44ms (88.40ms)" [ref=e114] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e121]:
      ...
      - link "Zapytania OutgoingParcelPostDeleteView" [ref=e123] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e124]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e125]
      - link "SQL 9 queries in 5.57ms" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
    ...
    - listitem [ref=e130]:
      ...
      - link "Templatki parcels/outgoingparcelpost_confirm_delete.html" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
