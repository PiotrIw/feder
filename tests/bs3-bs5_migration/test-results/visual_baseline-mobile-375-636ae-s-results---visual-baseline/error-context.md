...
- Name: visual_baseline.spec.ts >> mobile (375px) >> monitorings-results - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 434px by 1967px, received 480px by 1854px. 190601 pixels (ratio 0.21 of all image pixels) are different.

  Snapshot: monitorings-results-mobile.png

Call log:
  - Expect "toHaveScreenshot(monitorings-results-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
      ...
      - generic [ref=e95]:
        ...
        - generic [ref=e190]:
          - list [ref=e191]:
            ...
            - listitem [ref=e200]:
              - generic [ref=e201]: Wyniki
          - heading "Wyniki" [level=3] [ref=e202]
          - generic [ref=e203]:
            - heading "Temat e-mail" [level=5] [ref=e204]
            - generic [ref=e205]: Wniosek o udostępnienie informacji publicznej
            - heading "Podsumowanie wyników" [level=5] [ref=e208]
            - generic [ref=e209]:
              - paragraph
      - generic [ref=e210]:
        - generic [ref=e211]:
  ...
  - list [ref=e223]:
    ...
    - listitem [ref=e230]:
      ...
      - link "Historia /monitoringi/monitoring-sadow-apelacyjnych/results" [ref=e232] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e233]:
    ...
    - listitem [ref=e236]:
      ...
      - 'link "Czas CPU: 259.04ms (250.46ms)" [ref=e238] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e239]:
    ...
    - listitem [ref=e245]:
      ...
      - link "Zapytania MonitoringResultsView" [ref=e247] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e248]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e249]
      - link "SQL 60 queries in 28.01ms" [ref=e250] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e251]:
    ...
    - listitem [ref=e254]:
      ...
      - link "Templatki monitorings/monitoring_results.html" [ref=e256] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e257]:
    ...
    - listitem [ref=e260]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e262] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e263]:
