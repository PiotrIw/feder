...
- Name: visual_baseline.spec.ts >> mobile (375px) >> about - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 1075px, received 375px by 1158px. 172993 pixels (ratio 0.40 of all image pixels) are different.

  Snapshot: about-mobile.png

Call log:
  - Expect "toHaveScreenshot(about-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e70]:
        - heading "O stronie Obywatelskie fedrowanie danych" [level=2] [ref=e71]
        - paragraph [ref=e72]: Do najważniejszych problemów debaty publicznej niewątpliwie zalicza się częste opieranie argumentacji na nieweryfikowalnych lub nieaktualnych danych.
        - paragraph [ref=e73]: Informacje posiadane przez organy administracji publicznej są skarbnicą wiedzy. Ich skuteczne wykorzystanie pozwoliłoby rozwiać wiele pojawiających się wątpliwości. Niestety, forma ich przechowywania i udostępniania często uniemożliwia łatwe ich odczytanie oraz intepretację, w szczególności przy użyciu technik cyfrowych.
        - paragraph [ref=e74]: Fedrowanie danych jest projektem powstałym w odpowiedzi na to wyzwanie. Ma na celu usystematyzowanie dużej liczby informacji spływających od instytucji publicznych oraz zapisanie ich w formie łatwej do analizy, zarówno przez człowieka, jak i maszynę. Zebrane i uporządkowane przy wsparciu AI dane służą następnie do przeprowadzania badań, które to przyczyniają się do wzrostu świadomości społecznej i poprawy jakości rządzenia.
        - paragraph [ref=e75]: Treści na stronie zorganizowane są poprzez monitoringi, które są grupą tematycznie powiązanych zapytań. Składają się one z wielu spraw, które tworzymy przed wysłaniem zapytania do dowolnego urzędu. Każda sprawa zawiera wiele listów wymienionych z danym urzędem.
      - generic [ref=e76]:
        - generic [ref=e77]:
  ...
  - list [ref=e89]:
    ...
    - listitem [ref=e96]:
      ...
      - link "Historia /o-stronie/" [ref=e98] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e99]:
    ...
    - listitem [ref=e102]:
      ...
      - 'link "Czas CPU: 57.89ms (59.21ms)" [ref=e104] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e105]:
    ...
    - listitem [ref=e111]:
      ...
      - link "Zapytania TemplateView" [ref=e113] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e114]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e115]
      - link "SQL 4 queries in 1.15ms" [ref=e116] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e117]:
    ...
    - listitem [ref=e120]:
      ...
      - link "Templatki pages/about.html" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
    ...
    - listitem [ref=e126]:
      ...
      - link "Cache 3 wywołania w 0.16ms" [ref=e128] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e129]:
