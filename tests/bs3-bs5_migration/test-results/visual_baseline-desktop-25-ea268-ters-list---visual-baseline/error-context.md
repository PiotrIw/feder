...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> letters-list - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 2560px by 1497px, received 2560px by 1518px. 416321 pixels (ratio 0.11 of all image pixels) are different.

  Snapshot: letters-list-desktop.png

Call log:
  - Expect "toHaveScreenshot(letters-list-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
      ...
      - generic [ref=e48]:
        ...
        - listitem [ref=e56]:
          - link "Wyloguj" [ref=e57] [cursor=pointer]:
            - /url: /accounts/logout/
    - generic [ref=e60]:
      - heading "Listy przypisane do spraw" [level=2] [ref=e62]
      - generic [ref=e63]:
        - generic [ref=e64]:
          - generic [ref=e66]:
            - generic [ref=e67]:
  ...
  - list [ref=e226]:
    ...
    - listitem [ref=e233]:
      ...
      - link "Historia /listy/" [ref=e235] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e236]:
    ...
    - listitem [ref=e239]:
      ...
      - 'link "Czas CPU: 830.94ms (1919.23ms)" [ref=e241] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e242]:
    ...
    - listitem [ref=e248]:
      ...
      - link "Zapytania LetterListView" [ref=e250] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e251]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e252]
      - link "SQL 20 queries in 1415.41ms" [ref=e253] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e254]:
    ...
    - listitem [ref=e257]:
      ...
      - link "Templatki letters/letter_filter.html" [ref=e259] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e260]:
    ...
    - listitem [ref=e263]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e265] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e266]:
