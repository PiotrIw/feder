...
- Name: visual_baseline.spec.ts >> mobile (375px) >> monitorings-perm-add - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 898px, received 375px by 817px. 173740 pixels (ratio 0.52 of all image pixels) are different.

  Snapshot: monitorings-perm-add-mobile.png

Call log:
  - Expect "toHaveScreenshot(monitorings-perm-add-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
    ...
    - generic [ref=e68]:
      ...
      - heading [level=2] [ref=e91]:
        - link "Monitoring sądów apelacyjnych" [ref=e93] [cursor=pointer]:
          - /url: /monitoringi/monitoring-sadow-apelacyjnych
      - generic [ref=e94]:
        - paragraph [ref=e95]: Krok 1 z 2
        - generic [ref=e96]:
          - generic [ref=e97]:
            - generic [ref=e98]: Użytkownik / użytkowniczka*
            - combobox [aria-hidden] [ref=e99]
            - combobox [ref=e102] [cursor=pointer]:
              - textbox
          - table
          - button "wyślij" [ref=e103] [cursor=pointer]
      - generic [ref=e104]:
        - generic [ref=e105]:
  ...
  - list [ref=e117]:
    ...
    - listitem [ref=e124]:
      ...
      - link "Historia /monitoringi/monitoring-sadow-apelacyjnych/~uprawnienia/~dodaj" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
    ...
    - listitem [ref=e130]:
      ...
      - 'link "Czas CPU: 98.91ms (101.03ms)" [ref=e132] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e133]:
    ...
    - listitem [ref=e139]:
      ...
      - link "Zapytania PermissionWizard" [ref=e141] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e142]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e143]
      - link "SQL 6 queries in 1.85ms" [ref=e144] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e145]:
    ...
    - listitem [ref=e148]:
      ...
      - link "Templatki monitorings/permission_wizard.html" [ref=e150] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e151]:
    ...
    - listitem [ref=e154]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e156] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e157]:
