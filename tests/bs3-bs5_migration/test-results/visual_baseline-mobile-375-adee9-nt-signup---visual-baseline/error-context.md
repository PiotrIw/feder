...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-signup - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  171694 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: account-signup-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-signup-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e93]:
    ...
    - listitem [ref=e106]:
      ...
      - 'link "Czas CPU: 76.15ms (71.65ms)" [ref=e108] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e118]:
      ...
      - link "SQL 7 queries in 2.50ms" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
    ...
    - listitem [ref=e130]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
