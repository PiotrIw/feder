...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> account-reauthenticate - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  306644 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: account-reauthenticate-desktop.png

Call log:
  - Expect "toHaveScreenshot(account-reauthenticate-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e23]:
    ...
    - listitem [ref=e36]:
      ...
      - 'link "Czas CPU: 69.35ms (70.86ms)" [ref=e38] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e39]:
    ...
    - listitem [ref=e48]:
      ...
      - link "SQL 4 queries in 1.11ms" [ref=e50] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e51]:
