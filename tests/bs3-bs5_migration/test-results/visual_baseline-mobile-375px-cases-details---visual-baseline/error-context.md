...
- Name: visual_baseline.spec.ts >> mobile (375px) >> cases-details - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 478px by 5807px, received 540px by 6279px. 365855 pixels (ratio 0.11 of all image pixels) are different.

  Snapshot: cases-details-mobile.png

Call log:
  - Expect "toHaveScreenshot(cases-details-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e255]:
    ...
    - listitem [ref=e268]:
      ...
      - 'link "Czas CPU: 137.84ms (143.89ms)" [ref=e270] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e271]:
    ...
    - listitem [ref=e280]:
      ...
      - link "SQL 18 queries in 7.80ms" [ref=e282] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e283]:
