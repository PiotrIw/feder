...
- Name: visual_baseline.spec.ts >> mobile (375px) >> monitorings-letters - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 434px by 15029px, received 480px by 15484px. 721492 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: monitorings-letters-mobile.png

Call log:
  - Expect "toHaveScreenshot(monitorings-letters-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e601]:
    ...
    - listitem [ref=e614]:
      ...
      - 'link "Czas CPU: 315.80ms (319.02ms)" [ref=e616] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e617]:
    ...
    - listitem [ref=e626]:
      ...
      - link "SQL 61 queries in 34.01ms" [ref=e628] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e629]:
    ...
    - listitem [ref=e638]:
      ...
      - link "Cache 2 wywołania w 0.20ms" [ref=e640] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e641]:
