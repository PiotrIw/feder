...
- Name: visual_baseline.spec.ts >> mobile (375px) >> letters-assign - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 1601px, received 375px by 1743px. 204091 pixels (ratio 0.32 of all image pixels) are different.

  Snapshot: letters-assign-mobile.png

Call log:
  - Expect "toHaveScreenshot(letters-assign-mobile.png)" with timeout 5000ms
