...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-reset-password-from-key-done - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  167255 pixels (ratio 0.55 of all image pixels) are different.

  Snapshot: account-reset-password-from-key-done-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-reset-password-from-key-done-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e71]:
        ...
        - paragraph [ref=e73]: Twoje hasło zostało zmienione.
      - generic [ref=e74]:
        - generic [ref=e75]:
  ...
  - list [ref=e87]:
    ...
    - listitem [ref=e94]:
      ...
      - link "Historia /accounts/password/reset/key/done/" [ref=e96] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e97]:
    ...
    - listitem [ref=e100]:
      ...
      - 'link "Czas CPU: 63.20ms (64.48ms)" [ref=e102] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e103]:
    ...
    - listitem [ref=e109]:
      ...
      - link "Zapytania PasswordResetFromKeyDoneView" [ref=e111] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e112]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e113]
      - link "SQL 4 queries in 1.02ms" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - link "Templatki account/password_reset_from_key_done.html" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
