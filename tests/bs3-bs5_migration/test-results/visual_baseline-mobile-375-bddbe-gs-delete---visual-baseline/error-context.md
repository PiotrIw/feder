...
- Name: visual_baseline.spec.ts >> mobile (375px) >> monitorings-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 840px, received 375px by 812px. 173696 pixels (ratio 0.56 of all image pixels) are different.

  Snapshot: monitorings-delete-mobile.png

Call log:
  - Expect "toHaveScreenshot(monitorings-delete-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      ...
      - generic [ref=e94]:
        ...
        - button "Usuń" [ref=e96] [cursor=pointer]
      - generic [ref=e97]:
        - generic [ref=e98]:
  ...
  - list [ref=e110]:
    ...
    - listitem [ref=e117]:
      ...
      - link "Historia /monitoringi/monitoring-sadow-apelacyjnych/~usun" [ref=e119] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e120]:
    ...
    - listitem [ref=e123]:
      ...
      - 'link "Czas CPU: 75.25ms (77.55ms)" [ref=e125] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e126]:
    ...
    - listitem [ref=e132]:
      ...
      - link "Zapytania MonitoringDeleteView" [ref=e134] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e135]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e136]
      - link "SQL 7 queries in 2.20ms" [ref=e137] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e138]:
    ...
    - listitem [ref=e141]:
      ...
      - link "Templatki monitorings/monitoring_confirm_delete.html" [ref=e143] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e144]:
    ...
    - listitem [ref=e147]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e149] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e150]:
