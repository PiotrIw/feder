...
- Name: visual_baseline.spec.ts >> mobile (375px) >> casetags-create - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 812px, received 383px by 812px. 169135 pixels (ratio 0.54 of all image pixels) are different.

  Snapshot: casetags-create-mobile.png

Call log:
  - Expect "toHaveScreenshot(casetags-create-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e72]: / Dodaj tag
      - link "Utwórz" [ref=e75] [cursor=pointer]:
        - /url: /sprawy/tagi/monitoring-44/~create
      - generic [ref=e78]:
        - generic [ref=e79]:
          - generic [ref=e80]: Nazwa*
          - textbox "Nazwa*" [ref=e81]
        - button "Zapisz" [ref=e84] [cursor=pointer]
      - generic [ref=e85]:
        - generic [ref=e86]:
  ...
  - list [ref=e98]:
    ...
    - listitem [ref=e105]:
      ...
      - link "Historia /sprawy/tagi/monitoring-44/~create" [ref=e107] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e108]:
    ...
    - listitem [ref=e111]:
      ...
      - 'link "Czas CPU: 80.72ms (82.74ms)" [ref=e113] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e114]:
    ...
    - listitem [ref=e120]:
      ...
      - link "Zapytania TagCreateView" [ref=e122] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e124]
      - link "SQL 6 queries in 1.94ms" [ref=e125] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e126]:
    ...
    - listitem [ref=e129]:
      ...
      - link "Templatki cases_tags/tag_form.html" [ref=e131] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e132]:
