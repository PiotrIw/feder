...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> parcels-outgoing-delete - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  347959 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: parcels-outgoing-delete-desktop.png

Call log:
  - Expect "toHaveScreenshot(parcels-outgoing-delete-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e91]:
    ...
    - listitem [ref=e98]:
      ...
      - link "Historia /przesylki/outgoing-1/~delete" [ref=e100] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e101]:
    ...
    - listitem [ref=e104]:
      ...
      - 'link "Czas CPU: 75.74ms (77.85ms)" [ref=e106] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e107]:
    ...
    - listitem [ref=e113]:
      ...
      - link "Zapytania OutgoingParcelPostDeleteView" [ref=e115] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e116]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e117]
      - link "SQL 9 queries in 2.75ms" [ref=e118] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e119]:
    ...
    - listitem [ref=e122]:
      ...
      - link "Templatki parcels/outgoingparcelpost_confirm_delete.html" [ref=e124] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e125]:
