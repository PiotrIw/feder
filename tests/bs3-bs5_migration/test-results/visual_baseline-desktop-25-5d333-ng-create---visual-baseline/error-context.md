...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> parcels-incoming-create - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  337912 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: parcels-incoming-create-desktop.png

Call log:
  - Expect "toHaveScreenshot(parcels-incoming-create-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - list [ref=e61]:
        ...
        - listitem [ref=e66]: / Dodaj przychodzącą przesyłkę pocztową
      - heading "Dodaj przychodzącą przesyłkę pocztową" [level=2] [ref=e68]
      - generic [ref=e71]:
        - generic [ref=e72]:
  ...
  - list [ref=e105]:
    ...
    - listitem [ref=e112]:
      ...
      - link "Historia /przesylki/~create-incoming-2684" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - 'link "Czas CPU: 108.66ms (111.10ms)" [ref=e120] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e121]:
    ...
    - listitem [ref=e127]:
      ...
      - link "Zapytania IncomingParcelPostCreateView" [ref=e129] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e130]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e131]
      - link "SQL 7 queries in 2.36ms" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
    ...
    - listitem [ref=e136]:
      ...
      - link "Templatki parcels/incomingparcelpost_form.html" [ref=e138] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e139]:
