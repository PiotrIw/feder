...
- Name: visual_baseline.spec.ts >> mobile (375px) >> institutions-details - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 386px by 1023px, received 383px by 974px. 181505 pixels (ratio 0.46 of all image pixels) are different.

  Snapshot: institutions-details-mobile.png

Call log:
  - Expect "toHaveScreenshot(institutions-details-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - list [ref=e69]:
        ...
        - listitem [ref=e74]:
          ...
          - link "Trzcianka" [ref=e75] [cursor=pointer]:
            - /url: /jst/trzcianka-2
        - listitem [ref=e76]: / ,,KOMBUD” Sp. z o. o.
      - generic [ref=e78]:
      ...
      - heading ",,KOMBUD” Sp. z o. o." [level=2] [ref=e82]
      - generic [ref=e84]:
        - generic [ref=e86]:
          - paragraph [ref=e87]: "E-mail: kombud@trzcianka.com.pl"
          - paragraph [ref=e88]: "Archiwalne:"
          - paragraph [ref=e90]:
            - text: "Tagi:"
            - link "spółki komunalne" [ref=e91] [cursor=pointer]:
              - /url: /instytucje/?tags=158
        - generic [ref=e92]:
          - heading "Sprawy" [level=2] [ref=e93]
          - generic [ref=e94]:
            - heading [level=3] [ref=e95]:
              - link "Jawność w spółkach komunalnych" [ref=e97] [cursor=pointer]:
                - /url: /monitoringi/jawnosc-w-spolkach-komunalnych
            - heading [level=5] [ref=e100]:
              - 'link "Jawność w spółkach komunalnych #31" [ref=e102] [cursor=pointer]':
                - /url: /sprawy/jawnosc-w-spolkach-komunalnych-31
      - generic [ref=e103]:
        - generic [ref=e104]:
          - text: Sieć Obywatelska - Watchdog Polska ul. Szpitalna 5/5 00-031 Warszawa
          - paragraph [ref=e105]:
            - link "Klauzula RODO" [ref=e106] [cursor=pointer]:
              - /url: https://fedrowanie.siecobywatelska.pl/media_internal/tinycontent/uploads/11_KLAUZULA.-.dane.z.udip.na.stronach.www.i.w.mediach.spol.pdf
        - generic [ref=e107]:
          - text: "silnik:"
          - link "jawne.info.pl" [ref=e108] [cursor=pointer]:
            - /url: http://jawne.info.pl
          - text: "| v1.5.77.deps |"
          - link "GitHub" [ref=e109] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder
          - text: –
          - link "efd8a3b" [ref=e111] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder/compare/efd8a3b2...master
          - text: "|"
          - link "API" [ref=e112] [cursor=pointer]:
            - /url: /api/
        - generic [ref=e114]: Ta strona wykorzystuje cookies.
  - list [ref=e116]:
    - listitem [ref=e117]:
      - link "Ukryj »" [ref=e118] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e119]:
      - link "Toggle Theme" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e123]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e124]
      - link "Historia /instytucje/kombud-sp-z-o-o" [ref=e125] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e126]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e127]
      - link "Wersje Django 5.2.17" [ref=e128] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e129]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e130]
      - 'link "Czas CPU: 288.40ms (280.20ms)" [ref=e131] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e132]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e133]
      - link "Ustawienia" [ref=e134] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e135]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e136]
      - link "Nagłówki" [ref=e137] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e138]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e139]
      - link "Zapytania InstitutionDetailView" [ref=e140] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e141]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e142]
      - link "SQL 10 queries in 4.91ms" [ref=e143] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e144]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e145]
      - link "Pliki statyczne 3 użyte plików" [ref=e146] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e147]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e148]
      - link "Templatki institutions/institution_detail.html" [ref=e149] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e150]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e151]
      - link "Alerty" [ref=e152] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e153]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e154]
      - link "Cache 2 wywołania w 0.14ms" [ref=e155] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e156]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e157]
      - link "Sygnały 88 odbiorców 15 sygnałów" [ref=e158] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e159]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e160]
      - link "Gmina" [ref=e161] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e162]:
      - checkbox "Enable for next and successive requests" [ref=e163]
      - generic [ref=e164]: Przechwycone przekierowania
    - listitem [ref=e165]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e166]
      - link "Profilowanie" [ref=e167] [cursor=pointer]:
        - /url: "#"
```
