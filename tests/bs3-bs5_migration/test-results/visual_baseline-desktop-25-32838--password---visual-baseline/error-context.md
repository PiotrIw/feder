...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> account-set-password - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  334839 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: account-set-password-desktop.png

Call log:
  - Expect "toHaveScreenshot(account-set-password-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e91]:
    ...
    - listitem [ref=e104]:
      ...
      - 'link "Czas CPU: 95.37ms (89.38ms)" [ref=e106] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e107]:
    ...
    - listitem [ref=e116]:
      ...
      - link "SQL 3 queries in 0.96ms" [ref=e118] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e119]:
    ...
    - listitem [ref=e128]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e130] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e131]:
