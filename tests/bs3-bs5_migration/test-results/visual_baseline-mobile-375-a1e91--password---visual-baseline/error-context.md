...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-change-password - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  172090 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: account-change-password-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-change-password-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e71]:
        - heading "Zmień hasło" [level=2] [ref=e72]
        - generic [ref=e73]:
          - generic [ref=e74]:
            - generic [ref=e75]: Obecne hasło*
            - textbox "Obecne hasło*" [ref=e76]:
              - /placeholder: Obecne hasło
            - link "Zapomniałeś hasła?" [ref=e78] [cursor=pointer]:
              - /url: /accounts/password/reset/
          - generic [ref=e79]:
            - generic [ref=e80]: Nowe hasło*
            - textbox "Nowe hasło*" [ref=e81]:
              - /placeholder: Nowe hasło
          - generic [ref=e82]:
            - generic [ref=e83]: Nowe hasło (ponownie)*
            - textbox "Nowe hasło (ponownie)*" [ref=e84]:
              - /placeholder: Nowe hasło (ponownie)
          - button "Zmień hasło" [ref=e85] [cursor=pointer]
      - generic [ref=e86]:
        - generic [ref=e87]:
  ...
  - list [ref=e99]:
    ...
    - listitem [ref=e106]:
      ...
      - link "Historia /accounts/password/change/" [ref=e108] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e112]:
      ...
      - 'link "Czas CPU: 79.18ms (81.04ms)" [ref=e114] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e121]:
      ...
      - link "Zapytania PasswordChangeView" [ref=e123] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e124]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e125]
      - link "SQL 4 queries in 1.24ms" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
    ...
    - listitem [ref=e130]:
      ...
      - link "Templatki account/password_change.html" [ref=e132] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e133]:
    ...
    - listitem [ref=e136]:
      ...
      - link "Cache 2 wywołania w 0.13ms" [ref=e138] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e139]:
