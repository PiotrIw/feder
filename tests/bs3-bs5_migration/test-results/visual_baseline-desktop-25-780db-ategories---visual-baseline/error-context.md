...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> monitorings-answers-categories - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  387734 pixels (ratio 0.11 of all image pixels) are different.

  Snapshot: monitorings-answers-categories-desktop.png

Call log:
  - Expect "toHaveScreenshot(monitorings-answers-categories-desktop.png)" with timeout 5000ms
    ...
    - generic [ref=e60]:
      ...
      - generic [ref=e87]:
        ...
        - generic [ref=e182]:
          ...
          - heading "Kategorie odpowiedzi" [level=3] [ref=e194]
          - generic [ref=e195]:
            - paragraph [ref=e196]: "Uwaga: Proszę sporządzić przejrzystą listę co najmniej 2 kategorii odpowiedzi, używając wypunktowań literowych z \")\". Możesz dodać dodatkową instrukcję dla LLM po liście i linii separatora zawierającej ```, jak w poniższym przykładzie: __________________________________________________________ a) Tak b) Nie c) Nie jestem pewien ``` W przypadku jakichkolwiek wątpliwości użyj \"c) Nie jestem pewien” jako odpowiedzi."
            - button "Wygeneruj zadania kategoryzacji odpowiedzi w sprawach" [ref=e199] [cursor=pointer]
      - generic [ref=e200]:
        - generic [ref=e201]:
          - text: Sieć Obywatelska - Watchdog Polska ul. Szpitalna 5/5 00-031 Warszawa
          - paragraph [ref=e202]:
            - link "Klauzula RODO" [ref=e203] [cursor=pointer]:
              - /url: https://fedrowanie.siecobywatelska.pl/media_internal/tinycontent/uploads/11_KLAUZULA.-.dane.z.udip.na.stronach.www.i.w.mediach.spol.pdf
        - generic [ref=e204]:
          - text: "silnik:"
          - link "jawne.info.pl" [ref=e205] [cursor=pointer]:
            - /url: http://jawne.info.pl
          - text: "| v1.5.77.deps |"
          - link "GitHub" [ref=e206] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder
          - text: –
          - link "efd8a3b" [ref=e208] [cursor=pointer]:
            - /url: https://github.com/watchdogpolska/feder/compare/efd8a3b2...master
          - text: "|"
          - link "API" [ref=e209] [cursor=pointer]:
            - /url: /api/
        - generic [ref=e211]: Ta strona wykorzystuje cookies.
  - list [ref=e213]:
    - listitem [ref=e214]:
      - link "Ukryj »" [ref=e215] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e216]:
      - link "Toggle Theme" [ref=e217] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e220]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e221]
      - link "Historia /monitoringi/monitoring-sadow-apelacyjnych/answers-categories" [ref=e222] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e223]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e224]
      - link "Wersje Django 5.2.17" [ref=e225] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e226]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e227]
      - 'link "Czas CPU: 223.31ms (253.14ms)" [ref=e228] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e229]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e230]
      - link "Ustawienia" [ref=e231] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e232]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e233]
      - link "Nagłówki" [ref=e234] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e235]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e236]
      - link "Zapytania MonitoringAnswersCategoriesView" [ref=e237] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e238]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e239]
      - link "SQL 62 queries in 31.29ms" [ref=e240] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e241]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e242]
      - link "Pliki statyczne 3 użyte plików" [ref=e243] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e244]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e245]
      - link "Templatki monitorings/monitoring_answers_categories.html" [ref=e246] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e247]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e248]
      - link "Alerty" [ref=e249] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e250]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e251]
      - link "Cache 2 wywołania w 0.12ms" [ref=e252] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e253]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e254]
      - link "Sygnały 88 odbiorców 15 sygnałów" [ref=e255] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e256]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e257]
      - link "Gmina" [ref=e258] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e259]:
      - checkbox "Enable for next and successive requests" [ref=e260]
      - generic [ref=e261]: Przechwycone przekierowania
    - listitem [ref=e262]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e263]
      - link "Profilowanie" [ref=e264] [cursor=pointer]:
        - /url: "#"
```
