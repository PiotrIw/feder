...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-set-password - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  172084 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: account-set-password-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-set-password-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e99]:
    ...
    - listitem [ref=e112]:
      ...
      - 'link "Czas CPU: 78.81ms (80.27ms)" [ref=e114] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e124]:
      ...
      - link "SQL 3 queries in 0.80ms" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
