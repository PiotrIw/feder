...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> users-list - visual baseline
...
Timeout: 5000ms
  ...
  Snapshot: users-list-desktop.png

Call log:
  - Expect "toHaveScreenshot(users-list-desktop.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 2560px by 8962px, received 2560px by 9004px. 467678 pixels (ratio 0.03 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e459]:
    ...
    - listitem [ref=e466]:
      ...
      - link "Historia /uzytkownik/" [ref=e468] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e469]:
    ...
    - listitem [ref=e472]:
      ...
      - 'link "Czas CPU: 103.68ms (105.51ms)" [ref=e474] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e475]:
    ...
    - listitem [ref=e481]:
      ...
      - link "Zapytania UserListView" [ref=e483] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e484]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e485]
      - link "SQL 5 queries in 3.41ms" [ref=e486] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e487]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e488]
      - link "Pliki statyczne 3 użyte plików" [ref=e489] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e490]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e491]
      - link "Templatki users/user_list.html" [ref=e492] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e493]:
