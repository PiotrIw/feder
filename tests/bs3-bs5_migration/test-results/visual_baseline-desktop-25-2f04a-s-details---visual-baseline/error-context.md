...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> casetags-details - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  332389 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: casetags-details-desktop.png

Call log:
  - Expect "toHaveScreenshot(casetags-details-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e90]:
    ...
    - listitem [ref=e97]:
      ...
      - link "Historia /sprawy/tagi/monitoring-44/2" [ref=e99] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e100]:
    ...
    - listitem [ref=e103]:
      ...
      - 'link "Czas CPU: 75.40ms (77.95ms)" [ref=e105] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e106]:
    ...
    - listitem [ref=e112]:
      ...
      - link "Zapytania TagDetailView" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e116]
      - link "SQL 7 queries in 2.64ms" [ref=e117] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e118]:
    ...
    - listitem [ref=e121]:
      ...
      - link "Templatki cases_tags/tag_detail.html" [ref=e123] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e124]:
    ...
    - listitem [ref=e127]:
      ...
      - link "Cache 2 wywołania w 0.16ms" [ref=e129] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e130]:
