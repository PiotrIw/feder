...
- Name: visual_baseline.spec.ts >> mobile (375px) >> account-email-verification-sent - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  166834 pixels (ratio 0.55 of all image pixels) are different.

  Snapshot: account-email-verification-sent-mobile.png

Call log:
  - Expect "toHaveScreenshot(account-email-verification-sent-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e10]:
    ...
    - generic [ref=e68]:
      - generic [ref=e71]:
        - heading "Zweryfikuj swój adres e-mail" [level=2] [ref=e72]
        - paragraph [ref=e73]:
          - text: Przesłaliśmy weryfikacyjny e-mail na adres
          - link:
            - /url: "mailto:"
          - text: . Kliknij w łącze w wiadomości, aby zakończyć proces rejestracji. Skontaktuj się z nami, jeśli nie otrzymasz jej w ciągu kilku minut.
      - generic [ref=e74]:
        - generic [ref=e75]:
  ...
  - list [ref=e87]:
    ...
    - listitem [ref=e94]:
      ...
      - link "Historia /accounts/confirm-email/" [ref=e96] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e97]:
    ...
    - listitem [ref=e100]:
      ...
      - 'link "Czas CPU: 54.49ms (56.13ms)" [ref=e102] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e103]:
    ...
    - listitem [ref=e109]:
      ...
      - link "Zapytania email_verification_sent" [ref=e111] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e112]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e113]
      - link "SQL 4 queries in 1.13ms" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - link "Templatki account/verification_sent.html" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
    ...
    - listitem [ref=e124]:
      ...
      - link "Cache 2 wywołania w 0.11ms" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
