...
- Name: visual_baseline.spec.ts >> mobile (375px) >> home - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 415px by 2723px, received 415px by 2728px. 234146 pixels (ratio 0.21 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e240]:
    ...
    - listitem [ref=e253]:
      ...
      - 'link "Czas CPU: 139.36ms (339.29ms)" [ref=e255] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e256]:
    ...
    - listitem [ref=e265]:
      ...
      - link "SQL 40 queries in 205.70ms" [ref=e267] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e268]:
    ...
    - listitem [ref=e277]:
      ...
      - link "Cache 2 wywołania w 0.12ms" [ref=e279] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e280]:
