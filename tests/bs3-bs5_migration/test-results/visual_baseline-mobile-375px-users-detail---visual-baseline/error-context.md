...
- Name: visual_baseline.spec.ts >> mobile (375px) >> users-detail - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  171696 pixels (ratio 0.57 of all image pixels) are different.

  Snapshot: users-detail-mobile.png

Call log:
  - Expect "toHaveScreenshot(users-detail-mobile.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e93]:
    ...
    - listitem [ref=e106]:
      ...
      - 'link "Czas CPU: 65.49ms (67.74ms)" [ref=e108] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e109]:
    ...
    - listitem [ref=e118]:
      ...
      - link "SQL 8 queries in 2.58ms" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
