...
- Name: layout_assertions.spec.ts >> Layout sanity - mobile >> monitorings-template - no horizontal overflow on mobile
...
- generic [active] [ref=e1]:
  ...
  - list [ref=e234]:
    ...
    - listitem [ref=e247]:
      ...
      - 'link "Czas CPU: 262.09ms (263.08ms)" [ref=e249] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e250]:
    ...
    - listitem [ref=e259]:
      ...
      - link "SQL 60 queries in 29.13ms" [ref=e261] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e262]:
