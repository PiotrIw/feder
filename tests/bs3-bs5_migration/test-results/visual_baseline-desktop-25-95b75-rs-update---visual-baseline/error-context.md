...
- Name: visual_baseline.spec.ts >> desktop (2560px) >> users-update - visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  336290 pixels (ratio 0.10 of all image pixels) are different.

  Snapshot: users-update-desktop.png

Call log:
  - Expect "toHaveScreenshot(users-update-desktop.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e60]:
      - generic [ref=e63]:
        - 'heading "Użytkownik / użytkowniczka: claude_ai" [level=1] [ref=e64]'
        - generic [ref=e65]:
          - generic [ref=e66]:
            - generic [ref=e67]: Imię
            - textbox "Imię" [ref=e68]
          - generic [ref=e69]:
            - generic [ref=e70]: Nazwisko
            - textbox "Nazwisko" [ref=e71]
          - button "Aktualizuj" [ref=e73] [cursor=pointer]
      - generic [ref=e74]:
        - generic [ref=e75]:
  ...
  - list [ref=e87]:
    ...
    - listitem [ref=e94]:
      ...
      - link "Historia /uzytkownik/~aktualizuj/" [ref=e96] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e97]:
    ...
    - listitem [ref=e100]:
      ...
      - 'link "Czas CPU: 228.37ms (230.07ms)" [ref=e102] [cursor=pointer]':
        - /url: "#"
    - listitem [ref=e103]:
    ...
    - listitem [ref=e109]:
      ...
      - link "Zapytania UserUpdateView" [ref=e111] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e112]:
      - checkbox "Disable for next and successive requests" [checked] [ref=e113]
      - link "SQL 5 queries in 1.28ms" [ref=e114] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e115]:
    ...
    - listitem [ref=e118]:
      ...
      - link "Templatki users/user_form.html" [ref=e120] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e121]:
    ...
    - listitem [ref=e124]:
      ...
      - link "Cache 2 wywołania w 0.14ms" [ref=e126] [cursor=pointer]:
        - /url: "#"
    - listitem [ref=e127]:
